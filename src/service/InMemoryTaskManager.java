...
public class InMemoryTaskManager implements TaskManager {
    ...
    public int createEpic(Epic newEpic) {
        ...
        //Ёпики можно не валидировать, т.к. их временной диапазон напр€мую зависит от subTasks
        // и коллизи€ будет возникать именно из-за пересечени€ subTask и epic
...
//        updateTaskIfPresent(epics.get(newSubTask.getEpicID()));
    ...
    public int updateTask(Task updatedTask) {
        ...
        if(tasks.containsKey(updatedTask.getTaskID()))
            ...
            throw new IllegalArgumentException("ќтсутствует такой ID");
